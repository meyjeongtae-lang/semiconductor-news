window.COMPANIES_DATA = {
  ...
  "companies": [
    ...
    },
    {
      ...
      "hiring": {
        "status": "frequent",
        "note": "삼성 그룹 통합 채용 사이트(samsungcareers.com)에서 경력직 공고 16건이 진행 중인 것을 확인함(09/01 확인). 신입 정기공채는 하반기 라운드가 아직 시작 전으로 보임 — 즉 경력직은 상시로 열려있고, 신입 공채는 다음 라운드(통상 9월경 시작)를 기다리는 상태",
        "asOf": "2026-09-01",
    ...
    },
    {
      ...
      "hiring": {
        "status": "frequent",
        "note": "현대모비스 자체 채용사이트(careers.mobis.com)에서 경력직 상시채용 91건이 진행 중인 것을 확인함(개별 공고마다 마감일 다름, 예: 8/21~9/2, 8/28~9/8 등). 신입 정기공채는 상반기(2/25~3/13) 라운드가 마감된 이후 새 라운드가 아직 없음 — 즉 경력직은 상시로 열려있고, 신입 공채만 다음 라운드를 기다리는 상태",
    ...
    },
    {
      ...
      "hiring": {
        "status": "open",
        "note": "사람인에서 (주)케이씨텍이 직접 올린 반도체 소재 출하관리/운송 담당자, 품질보증 담당 경력직을 확인함(접수마감 10/19, 잡코리아엔 안 뜨고 사람인에서 확인됨, 09/01 확인) - 경력직 위주",
    ...
    },
    {
      ...
      "hiring": {
        "status": "open",
        "note": "사람인에서 (주)원익아이피에스가 직접 올린 반도체 공정개발 엔지니어, Supplier Engineer, SW엔지니어, 보안/인프라 담당자 등 경력직(3년 이상)을 다수 확인함(접수마감 9/17~9/18, 잡코리아엔 지금 0건이고 사람인에서 확인됨, 09/01 확인) - 경력직 위주, 신입 공고는 확인 안 됨",
    ...
    },
    {
      ...
      "hiring": {
        "status": "open",
        "note": "피에스케이홀딩스가 직접 올린 비서(계약직, 오늘마감)와 PSK 자회사 에스이앤에스의 반도체 장비 CS엔지니어 9차모집(신입, 9/13마감)이 확인됨(잡코리아 직접 확인, 08/31 확인)",
    ...
    },
    {
      ...
      "hiring": {
        "status": "open",
        "note": "한미반도체㈜가 직접 올린 서무(계약직) 채용이 진행 중으로 확인됨(인천, 접수마감 9/12 — 다만 사무보조 계약직 1건뿐이라 채용 규모는 크지 않아 보임, 잡코리아 직접 확인, 08/31 확인)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "open",
        "note": "LG그룹 공식 채용사이트(careers.lg.com)에서 \"2026년 하반기 LG이노텍 신입사원 채용\"(연구/개발) 공고를 직접 확인함(D-10, 09/01 확인)",
    ...
    },
    {
      ...
      "hiring": {
        "status": "open",
        "note": "사람인에서 한화에어로스페이스(주)가 직접 올린 대규모 신입사원 채용(항공사업부 R&D_기계/항공, MRO사업부 R&D)을 확인함(접수마감 9/20, 09/01 확인) - 신입 채용 있음",
        "url": "https://www.hanwhain.com/"
      },
