window.COMPANIES_DATA = {
  ...
  "companies": [
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "스크러버 검사·출하기술 등 일부 신입 공고는 있었지만, 대부분 경력직(로봇 Web개발·전략부품개발) 위주로 보여요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "채용 중인 직무(자동화로봇 제조·제어SW개발·기계설계 등)는 대부분 경력직으로 보여요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "운송·운전·납품 담당 신입 공고 등 일부만 확인됐고, 반도체 검사장비 관련 신입 공고는 뚜렷이 확인 안 됨(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "자동화 장비 설계 담당자 등 신입/경력 채용 이력은 있으나, 동명의 다른 회사(학원·로보틱스)와 섞여서 검색돼 구체적인 진행 중 공고는 확인 안 됨(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "2026년 상반기 각 부문 정규직 채용(신입/경력)이 있었지만 이미 지난 라운드로 보여요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "국세청 사업자 상태가 '폐업자'로 표시된다는 검색 결과가 있어요 — 회사가 실제로 폐업했는지, 단순 표기 오류인지 추가 확인이 필요해 보여요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "현재 보이는 공고는 PLC제어·전략기획 등 경력직 위주예요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "생산직 채용이 가장 잦은 편이고, 총무·사무 등도 이따금 채용해요. 현재 진행 중인 구체적 공고는 검색상 확인 안 됨(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "2026년 채용 일정은 아직 미확정이에요. 통상 상반기(3~5월)·하반기(9~11월)에 진행되는 편(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "잡코리아에서 '엑시콘' 신입 채용 검색 결과 0건(08/31 확인)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "2026년 하반기 신입/경력 채용(마감 6/7)이 있었지만 이미 지난 라운드로 보여요. 다음 일정은 공식 채용페이지 확인 필요(웹서치 기반)",
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "최근엔 경력 중심으로 채용하는 편이에요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "같은 이름의 다른 회사(스튜디오제이티 등)와 섞여서 검색되다 보니, JT Corp(반도체 자동화장비)의 구체적인 신입 채용 정보는 명확히 확인 안 됨(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "각 부문 신입/경력 모집(마감 2026-02-10)이 있었지만 이미 지난 라운드로 보여요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "2026년도 상반기 경력 및 신입사원 모집을 진행했지만 이미 지난 라운드로 보여요. 다음 일정은 공식 채용페이지 확인 필요(웹서치 기반)",
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "동명의 회사가 2곳(나노엑스코리아·나노엑스) 있어서 헷갈리기 쉬운데, 둘 다 진행 중인 신입 채용 정보는 명확히 확인 안 됨(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "2024년 하반기 각 부문별 신입/경력 채용 이력은 있으나, 현재 진행 중인 구체적 공고는 검색상 확인 안 됨(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "IT개발·영업/CS·생산·연구개발 등 신입 채용(접수 5/28~6/16)이 있었지만 이미 지난 라운드로 보여요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "상반기 부문별 신입/경력 채용(마감 2026-05-08)이 있었지만 이미 지난 라운드로 보여요. 다음 일정은 공식 채용페이지 확인 필요(웹서치 기반)",
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "정기 신입공채는 상반기(3~5월)·하반기(9~11월)에 진행되는 편이에요. 2026년 하반기 일정은 아직 미확정(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "직원 수 18명의 작은 회사라 채용이 매우 드문 편이에요. 과거(2024년) 회계·기구설계 등 부문별 신입·경력 채용 이력은 있어요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "반도체장비 유지보수 신입/경력 공고가 있었고, 최근 3년간 신입 채용 4회 실적이 있어요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "채용 방식이 특이해요 — 학교 지도교수 추천 후 면접으로 2~3명만 뽑는 소규모 채용이에요(C/C++/C# 개발 직무, 웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "최근 3년간 정규직 채용이 11회 있었을 만큼 채용이 잦은 편이지만, 현재 진행 중인 구체적 공고는 검색상 확인 안 됨(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "'아이엠티'라는 이름의 회사가 여러 개 있어서(엔지니어링·정밀기기·특수기계 등) 반도체 세정장비 회사인지 명확히 구분되는 채용정보를 못 찾았어요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "PLC설계·전장설계 등 신입 채용 이력은 있으나, 2025년 2월 상장폐지되며 회사 상황이 불안정해 보여요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "회사명이 흔한 약자(지리정보시스템 등)라 검색으로 구체적인 채용정보를 확인하지 못했어요. 2026년 네온테크와 합병·사명변경이 있었던 만큼 공식 채용페이지에서 직접 확인이 필요해요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "IT솔루션 영업·엔지니어 등 신입 채용 이력은 있어요. 통상 상반기(3~5월)·하반기(9~11월)에 채용하는 편(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "최근 1년간 채용이 잦은 편(10회 이상)이고 최신 채용은 2026-08-04예요. 다음 라운드는 공식 채용페이지 확인 필요(웹서치 기반)",
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "현재 보이는 공고는 대부분 경력직(CNC밀링·장비배선 등)이고, AI연구본부만 신입/경력 함께 모집 중이에요(웹서치 기반)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "한화그룹 채용사이트(hanwhain.com)를 통해서만 지원 가능해요. Core/Future Track 등 신입 트랙이 있지만 2026년 하반기 일정은 미확정(웹서치 기반)"
      },
