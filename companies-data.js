window.COMPANIES_DATA = {
  "generatedAt": "2026-08-31T15:49:06.766Z",
  "categories": {
  ...
  "companies": [
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "사람인·잡코리아 검색결과 전부 협력사(장비관리·설비유지보수 등 파견업체) 공고이고 삼성전자 본사 직접 공고는 안 보임 - 삼성전자는 job board가 아니라 자체 채용 사이트(career.samsung.com)로 공채를 진행하는 것으로 보임(09/01 확인)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "사람인 검색결과 전부 협력사(물류·보안경비 파견업체) 공고이고 동우화인켐 본사 직접 공고는 안 보임(09/01 확인)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "사람인·잡코리아 검색결과 전부 협력사(전산기기 유지보수 등 파견업체) 공고이고 삼성SDI 본사 직접 공고는 안 보임 - 자체 채용 사이트로 공채를 진행하는 것으로 보임(09/01 확인)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "사람인에 \"라온테크\"(㈜ 표기 없음) 이름으로 대전/경남 지역 CNC 기계가공 채용공고가 있으나, 반도체 웨이퍼 이송로봇 회사(2000년 설립, 코스닥 상장) 라온테크와 사업분야·지역이 달라 동명의 다른 회사로 판단해 채용 확인으로 인정하지 않음(09/01 확인)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "사람인에 헤드헌팅 업체(에이치알비즈코리아)가 올린 \"반도체 테스트 장비 개발사/상장사\" 베트남 근무 공고가 있는데 엑시콘일 가능성은 있지만 회사명이 명시되지 않아 직접 공고로 인정하지 않음(09/01 확인)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "사람인에 \"유진테크\" 공고가 있으나 중공성형기(플라스틱 성형기) 조작원 모집으로 반도체 장비회사 유진테크와 다른 동명 회사로 보여 채용 확인으로 인정하지 않음. 그 외엔 관련 공고 없음(09/01 확인)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "사람인 검색결과는 전부 한영회계법인(EY한영) 공고이고, 반도체 쿼츠 소재 회사 한영의 직접 공고는 안 보임(09/01 확인)"
      },
    ...
    },
    {
      ...
      "hiring": {
        "status": "unknown",
        "note": "사람인에 \"(주)아이엠티\" 공고가 있으나 대전 소재 방산장비(Firmware) 회사로 보여 반도체 장비회사 아이엠티(IMT)와 다른 동명 회사일 가능성이 있어 채용 확인으로 인정하지 않음(09/01 확인)"
      },
