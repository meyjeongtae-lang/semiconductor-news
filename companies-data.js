window.COMPANIES_DATA = {
  "generatedAt": "2026-08-30T13:52:03.094Z",
  "categories": {
  ...
  "companies": [
    {
      ...
      "desc": "세계 최대 종합반도체·전자기업이에요. 메모리반도체(D램·낸드플래시)를 만드는 사업부, 다른 회사가 설계한 반도체를 대신 생산해주는 파운드리(위탁생산) 사업부, 그리고 스마트폰·가전 사업까지 한 회사 안에 다 갖고 있는 게 특징이에요. 최근에는 HBM(고대역폭메모리) 등 AI 반도체 관련 메모리 기술 경쟁에서 SK하이닉스와 선두를 다투고 있어요."
    },
    {
      "name": "SK하이닉스",
      "category": "device_foundry",
    ...
    },
    {
      ...
      "desc": "화약·방산(무기)·기계·무역 사업을 하는 한화그룹의 모기업이에요. 반도체를 직접 만드는 회사는 아니고, 우리 목록에는 그룹의 소재·화학 관련 사업 비중 때문에 포함돼 있어요. 실제 반도체 장비 사업은 계열사인 한화세미텍이 따로 맡고 있어요."
    },
    {
      "name": "현대모비스",
      "category": "device_foundry",
      ...
      "desc": "현대자동차그룹의 핵심 부품 계열사예요. 원래는 자동차 전장(전자장치)·섀시·램프 같은 부품을 만드는 게 주력이었는데, 최근에는 전기차용 SiC(실리콘카바이드) 전력반도체를 자체 생산하는 사업에도 뛰어들고 있어요. 그래서 자동차 부품 회사면서 동시에 반도체 생산 역량도 키우는 중인 회사예요."
    },
    {
      "name": "고려아연",
      "category": "materials",
      ...
      "desc": "세계 1위 아연 제련회사예요. 아연·납 같은 비철금속을 광석에서 뽑아내는 제련 과정에서 여러 부산물이 나오는데, 이 중 일부를 반도체·2차전지용 고순도 소재로 가공해서 판매하는 사업도 함께 하고 있어요."
    },
    {
      "name": "세메스",
      "category": "equipment",
    ...
    },
    {
      ...
      "desc": "삼성그룹의 배터리(2차전지) 전문 계열사예요. 전기차·ESS(에너지저장장치)용 배터리가 주력 사업이고, 반도체 소재보다는 전자재료 사업을 일부 함께 하고 있어요."
    },
    {
      "name": "유니셈",
      "category": "equipment",
